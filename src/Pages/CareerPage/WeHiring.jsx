...
const WeHiring = () => {
    ...
    <Box className="we-man"  width={{ xs: '100%', sm: '90%', md: '85%' }} display="flex" alignItems="center" justifyContent="space-between" flexDirection={{ xs: 'column', sm: 'row' }} paddingY={5}>
        <Box width={{ xs: '100%', sm: '55%', md: '50%' }} marginBottom={{ xs: 4, sm: 0 }}>
            <img className='we-img' src={Careerhome} alt="" height="100%" width="100%" />
        </Box>
        <Box width={{ xs: '100%', sm: '80%', md: '45%', lg: '50%' }}>
            <Typography variant="h3" fontSize={{ xs: 30, sm: 40 }} fontWeight={600} color="#053480" marginBottom={2} textAlign={{ xs: 'center', sm: 'left' }}>
                We Are Hiring!
            </Typography>
            <Typography marginY={2}  fontSize={{ xs: 15, sm: 20 }} textAlign={{ xs: 'center', sm: 'left' }}>
