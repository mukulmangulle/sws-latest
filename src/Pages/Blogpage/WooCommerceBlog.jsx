...
const WooCommerceBlog = () => {
    return (
        <>
            <Box width={"100%"} display={"flex"} alignItems={"center"} justifyContent={"center"} >

                <Box width={"85%"} marginTop={7}>
                    <Typography marginLeft={3} marginBottom={7} variant='h4' color={"#053480"} fontWeight={600}>Woo Commerce Blog</Typography>
...
export default WooCommerceBlog;